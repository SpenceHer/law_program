...
class ProcessPDF:
    ...
    def organize_text_extraction(self, response, page, page_number):
        ...
        if texts:
            ...
            # processed_full_text = self.preprocess_text(full_text)
        else:
            full_text = ""
            # processed_full_text = ""
...
class PageComparison:
    ...
    def process_adjacent_page(self, current_page, adjacent_page, prefix, no_page=False):
        ...
        if no_page == False:
            ...
            result[f"{prefix}_page_bert_text_similarity"] = self.calculate_bert_text_similarity(current_page["full_text"], adjacent_page["full_text"])
            result[f"{prefix}_page_idf_text_similarity"] = self.calculate_idf_text_similarity(current_page["full_text"], adjacent_page["full_text"])
...
class PDFSeparation:
    ...
    def predict_start_pages(self):
        best_model = joblib.load('/Users/spencersmith/Desktop/CODING/Projects/law/code/my_flask_app/pdf_operations/pdf_separator/models/best_xgboost_model.pkl')
        scaler = joblib.load('/Users/spencersmith/Desktop/CODING/Projects/law/code/my_flask_app/pdf_operations/pdf_separator/models/scaler.pkl')
    ...
    def separate_pdf(self):
        ...
        output_folder = "/Users/spencersmith/Desktop/CODING/Projects/law/code/my_flask_app/static/split_pdfs"
